...
describe("StablePool", () => {
    ...
    let evmHelpers;
    before(async () => {
        sdkPool = await stable_1.default.initFromRealPool(
        // DAI/USDC/USDT on Mainnet
        "0x06df3b2bbb68adc8b0e302443692037ed9f91b42000000000000000000000063", true, Number(process.env.BLOCK_NUMBER));
